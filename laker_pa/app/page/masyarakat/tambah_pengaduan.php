        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-danger">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="page/masyarakat/process_tambah_pengaduan.php">

                <input type="text" name="register" value="-" hidden>
                <input type="text" name="id_input" value="<?php echo $_GET['userid'] ?>" hidden>

                <input type="text" name="status" value="masuk" hidden>
                <input type="text" name="progress" value="belum" hidden>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Masukkan kronologi" name="kronologi"></textarea>
                      </div>
                </div>
                <div class="form-group ">
                      <!-- textarea -->
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Masukkan alamat kejadian" name="lok_kejadian"></textarea>
                      </div>
                </div>
                <div class="form-group ">
                      <!-- textarea -->
