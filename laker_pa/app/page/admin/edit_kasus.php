        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="page/admin/process_edit_kasus.php">
                <input type="text" name="id_kasus" value="<?php echo $view['id'] ?>" hidden>

                <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">No Register</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="register" value="<?php echo $view['no_reg'] ;?>">
                    </div>
                <div class="form-group">
