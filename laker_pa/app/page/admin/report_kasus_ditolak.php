        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="col">
                <h3 class="">Report kasus ditolak petugas</h3>
                </div>
                <div class="col">
                <a href="page/admin/cetak_kasus_ditolak.php" target="_BLANK" class="btn btn-secondary btn-sm">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                    $no =0;
                    $query = mysqli_query($koneksi, "SELECT k.*, t.alasan_ditolak alasan FROM tb_kasus k 
                  ...
                  <tr>
                    ...
                    <td>
                      <a><?php echo $ksus['status'] ?></a>
                    </td>
                    <td>
                      <a><?php echo $ksus['alasan'] ?></a>
                    </td>
                  </tr>
                  <?php };?>
                  </tbody>
