...
<body>
    <center>
        ...
        <table  class="judul_laporan">
            <tr>
                <td class="judul">LAPORAN PENGGUNA APLIKASI</td><br><br>
            </tr>
        </table>
        <table border="1">
            <br><br>
                <tr class="thead">
                    ...
                    <td width="120" class="tengah">Level</td>
                </tr>
        </table>
        <table border="1">
        <?php
        ...
        ?>
            <tr class="isi_tabel">
                ...
                <td width="180"><?php echo $ksus['nama'];?></td>
                <td width="159"><?php echo $ksus['username'];?></td>
                <td width="150"><?php echo $ksus['password'];?></td>
                <td width="120"><?php echo $ksus['level'];?></td>
        <?php };?>
