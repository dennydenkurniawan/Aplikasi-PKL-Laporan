...
<body>
    <center>
        ...
        <table  class="judul_laporan">
            <tr>
                <td class="judul">LAPORAN KASUS SELESAI</td><br><br>
            </tr>
        </table>
        <table border="1">
            <br><br>
                <tr class="thead">
                    <td width="30">No</td>
                    <td width="150">Nomor Registrasi</td>
                    <td width="75">Tgl Laporan</td>
                    <td width="195">Kronologi</td>
                    <td width="100">Alamat Kejadian</td>
        ...
        ?>
            <tr class="isi_tabel">
                ...
                <td width="150" class="tengah"><?php echo $ksus['no_reg'];?></td>
                <td width="75"><?php echo $ksus['tgl'];?></td>
                <td width="195"><?php echo $ksus['kronologi'];?></td>
                <td width="100"><?php echo $ksus['alamat_kej'];?></td>
