...
<head>
  ...
  <title>Laker PA | Registrasi</title>
    ...
    <div class="login-box">
      ...
      <div class="card card-outline card-primary">
        ...
        <div class="card-body">
          ...
          <form action="conf/daftar_akun.php" method="post">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="Nomor Telpon" name="no_telp" required>
              <div class="input-group-append">
                <div class="input-group-text">
